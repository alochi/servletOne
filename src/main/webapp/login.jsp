		...
		<%=("noAuth".equals(request.getParameter("errorMsg")))?"Ошибка авторизации":""%>
            ...
            <div class="row">
              <div class="form-group col-md-10">
                ...
                <input class="form-control" id="txtusername" name="userName" type="text" placeholder="admin" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-10">
                <label class="form-label">Password</label> <span class="help"></span>
                <input class="form-control" id="txtpassword" name="userPassword" type="password" placeholder="123" required>
              </div>
            </div>
            <div class="row">
              <div class="col-md-10">
