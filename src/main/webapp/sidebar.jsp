...
<div class="page-sidebar " id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
        ...
        <ul>
            <li class="start active "><a href="#"><i class="material-icons">home</i> <span class="title">Link</span>
                <span class="selected"></span> </a>
            </li>
            <li class="">
                <a href="#"> <i class="material-icons">email</i> <span class="title">Link</span> <span
                        class=" badge badge-disable pull-right ">203</span>
                </a>
            </li>
            <li class="">
                <a href="javascript:;"> <i class="material-icons">more_horiz</i> <span class="title">Link</span> <span
                        class=" arrow"></span> </a>
                <ul class="sub-menu">
...
<div class="footer-widget">
    ...
    <div class="pull-right">
        <div class="details-status"><span class="animate-number" data-value="86" data-animation-duration="560">86</span>%
        </div>
