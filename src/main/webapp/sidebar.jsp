    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
        <div class="user-info-wrapper sm">
            ...
            <div class="user-info sm">
                <div class="username"><%=(String)request.getSession().getAttribute("login")%></div>
...
<div class="footer-widget">
    ...
    <div class="pull-right">
        <div class="details-status"><span class="animate-number" data-value="100" data-animation-duration="560">100</span>%
        </div>
        <a href="${pageContext.request.contextPath}/login?action=logout"><i class="material-icons">power_settings_new</i></a></div>
</div>
<!-- END SIDEBAR -->
